...
public class changepassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(85, 86, -1, -1));
        ...
        jPanel2.add(firstname, new org.netbeans.lib.awtextra.AbsoluteConstraints(23, 106, 196, 30));

        requiredfname.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jPanel2.add(requiredfname, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 144, 180, 10));

        lastnametext.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        lastnametext.setText("Last Name");
        jPanel2.add(lastnametext, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 86, -1, -1));
        ...
        jPanel2.add(lastname, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 106, 196, 30));

        requiredlname.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jPanel2.add(requiredlname, new org.netbeans.lib.awtextra.AbsoluteConstraints(271, 144, 190, 10));
        ...
        jPanel2.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(23, 178, 196, 30));

        emailtext.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        emailtext.setText("Email");
        jPanel2.add(emailtext, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 158, 54, -1));

        requiredemail.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jPanel2.add(requiredemail, new org.netbeans.lib.awtextra.AbsoluteConstraints(23, 214, 190, 10));
        ...
        jPanel2.add(changepassword1, new org.netbeans.lib.awtextra.AbsoluteConstraints(147, 255, 210, 30));

        cnumbertext.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        cnumbertext.setText("Contact Number");
        jPanel2.add(cnumbertext, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, -1, -1));

        requiredcnumber.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jPanel2.add(requiredcnumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(271, 212, 190, 10));

        idfieldtext1.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        ...
        jPanel2.add(Signup, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 320, 140, 40));
        ...
        jPanel2.add(backlogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 380, -1, -1));
        ...
        jPanel2.add(contactnumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(271, 178, 197, 30));

        passwordtext.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        passwordtext.setText("Password");
        jPanel2.add(passwordtext, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, -1, -1));

        requiredpassword.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jPanel2.add(requiredpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(147, 288, 190, 10));
        jPanel2.add(idfieldtext, new org.netbeans.lib.awtextra.AbsoluteConstraints(46, 54, 42, -1));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 30, 490, 420));
